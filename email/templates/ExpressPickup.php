     ...
     if (Date::isWeekend($this->date)) {
         if (!$this->isAdmin) {
            ...
            <p>Hemos recibido tu solicitud de entrega express. Los fines de
             ...
             $this->content = '<h3>Programada para fin de semana.</h3>
            <p style="margin-bottom: 40px;">Para confirmar la disponibilidad y programar esta entrega, <a href="http://users.maspostwarehouse.com/admin/confirm-express-pickup?id='.$this->expressId.'"> haz click aquí.</a>';
         }
     }  else {
